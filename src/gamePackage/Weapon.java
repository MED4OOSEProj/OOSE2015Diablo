...
public class Weapon extends Item {
	...
	public String[] weaponType = new String[]{"Axe","Sword","Mace","Pike","Spear","Javelin","Crossbow","Bow","Longbow","Throwing Knife"};
	
	// 0-2 are high dmg, 3-5 are fast weapons, 6-8 are durable, 10 is the most powerful EVeR! 
	public String[] suffix = new String[]{" of Mightiness"," of Slaying"," of the Knights Templar"," of Swiftslaying"," of Quicksilver"," of Quickness"," of Unreliable Power"," of the Unbreakable Vow"," of diamond endurance"," of Godslaying"};
